# Windows ML Resources

Resources for building Windows ML applications, including official documentation, AI Dev Gallery exported sample projects, WindowsAppSDK integration samples, and project templates.

This repository is designed to be used as a knowledge base for AI-assisted Windows ML development.
...
- Documentation in `Windows-ML-Docs/`: [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) (from MicrosoftDocs)
